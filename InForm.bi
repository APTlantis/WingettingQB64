...
DECLARE SUB uprint_extra (BYVAL x&, BYVAL y&, BYVAL chars%&, BYVAL length%&, BYVAL kern&, BYVAL do_render&, txt_width&, BYVAL charpos%&, charcount&, BYVAL colour~&, BYVAL max_width&)
DECLARE FUNCTION uprint (BYVAL x&, BYVAL y&, chars$, BYVAL txt_len&, BYVAL colour~&, BYVAL max_width&)
DECLARE FUNCTION uprintwidth (chars$, BYVAL txt_len&, BYVAL max_width&)
DECLARE FUNCTION uheight& ()
DECLARE FUNCTION falcon_uspacing& ()
DECLARE FUNCTION uascension& ()
